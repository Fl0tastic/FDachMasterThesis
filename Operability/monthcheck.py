...
T_TOT = pd.DataFrame(columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
                     index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
                            "Average (h)", "Average (days)"])
COST_TOT = pd.DataFrame(columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
                        index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
                               "Average (h)", "Average (days)"])
WAIT_TOT = pd.DataFrame(columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
                        index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
                               "Average (h)", "Average (days)"])

Waiting_position = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_transfer = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_connect = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_tower = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_nacelle = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_blade = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_commission = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_transit = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_wave = pd.DataFrame(columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
                          index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020",
                                 "Average (h)", "Average (days)"])

Waiting_wind = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
Waiting_tide = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])

Waiting_WindWave = pd.DataFrame(
    columns=['Month 1', 'Month 2', 'Month 3', 'Month 4', 'Month 5', 'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10','Month 11','Month 12'],
    index=["2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "Average (h)",
           "Average (days)"])
...
MaxDuration = 8760                                      # Limit for maximum run time, in this case 1yr
...
for size in range(1, 2):
    ...
    DurScenario = int(Data_Scenario.iloc[1, 1])  # 0=Mean, 1= Shorter, 2=Longer
    for month in months:
        for year in years:

            M_counter = int(month - 1)
            start_date = str(
                year) + month_str[M_counter] + '-01 10:00:00'  # starting on the first day of summer on the selected year
            ...
            duration_pos = math.ceil(
                DUR_POS)  # calculate the duration of step 2 and 3 to find the length of the weather window we need to find

            for i in range(0, len(met_data.datetime) - start):
                if (met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_pos - 1,
                    ['Hs']].max().item() <= HS_POS) and (
                        met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_pos - 1,
                        ['Tp']].max().item() <= TP_POS) and (
                        tide_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_pos - 1,
                    ...
                    if tide_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_pos - 1,
                       ['Tides']].max().item() < TI_POS:
            ...
            while WTB_Installed < N_WTB and TOTAL_TIME <= MaxDuration:  # Loop to run until all the desired number of turbines are installed
                ...
                DUR_LOAD_COMP = T_LOAD * (
                            N_TOW + N_BLADE / 3 + N_NAC)  # Step 2 Loading components on vessel from feeder
                duration_load = math.ceil(DUR_LOAD_COMP)

                for i in range(0, len(met_data.datetime) - start):
                    if (met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_load - 1,
                        ['Hs']].max().item() <= HS_LOAD) and (tide_data.loc[
                                                              start + math.ceil(TOTAL_TIME):start + math.ceil(
                                                                      TOTAL_TIME) + duration_load - 1,
                ...
                for i in range(0, len(met_data.datetime) - start):
                    if (met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_con - 1,
                        ['Hs']].max().item() <= HS_CON) and (tide_data.loc[
                                                             start + math.ceil(TOTAL_TIME):start + math.ceil(
                                                                     TOTAL_TIME) + duration_con - 1,
                ...
                for i in range(0, len(met_data.datetime) - start):
                    if (met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_tow - 1,
                        ['Hs']].max().item() <= HS_TOW) and (
                            met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_tow - 1,
                        ...
                        if met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_tow - 1,
                           ['WindSpeed']].max().item() > WS_TOW and (met_data.loc[
                                                                     start + math.ceil(TOTAL_TIME):start + math.ceil(
                                                                             TOTAL_TIME) + duration_tow - 1,
                                                                     ['Hs']].max().item() <= HS_TOW) and (met_data.loc[
                                                                                                          start + math.ceil(
                                                                                                                  TOTAL_TIME):start + math.ceil(
                                                                                                                  TOTAL_TIME) + duration_tow - 1,
                                                                                                          [
                                                                                                              'Tp']].max().item() <= TP_TOW):
                            waiting_wind = waiting_wind + 1
                             ...
                             ['WindSpeed']].max().item() <= WS_TOW and (met_data.loc[
                                                                        start + math.ceil(TOTAL_TIME):start + math.ceil(
                                                                                TOTAL_TIME) + duration_tow - 1,
                                                                        ['Hs']].max().item() > HS_TOW) or (met_data.loc[
                                                                                                           start + math.ceil(
                                                                                                                   TOTAL_TIME):start + math.ceil(
                                                                                                                   TOTAL_TIME) + duration_tow - 1,
                                                                                                           [
                ...
                for i in range(0, len(met_data.datetime) - start):
                    if (met_data.loc[start + math.ceil(TOTAL_TIME):start + math.ceil(TOTAL_TIME) + duration_com - 1,
                        ['Hs']].max().item() <= HS_COMM) and (tide_data.loc[
                                                              start + math.ceil(TOTAL_TIME):start + math.ceil(
                                                                      TOTAL_TIME) + duration_com - 1,
                ...
                if TOTAL_TIME < MaxDuration:
                    print('Turbine ', str(WTB_Installed+1), 'successfully installed after ', math.ceil(TOTAL_TIME / 24), 'days')
                    ActualTurbines=ActualTurbines=+1
            ...
            T_TOT.loc[str(year), 'Month ' + str(month)] = math.ceil(TOTAL_TIME)
            WAIT_TOT.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_wtb)
            Waiting_position.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_pos)
            Waiting_transfer.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_load)
            Waiting_connect.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_con)
            Waiting_tower.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_tow)
            Waiting_nacelle.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_nac)
            Waiting_blade.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_blade)
            Waiting_transit.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_trans)
            Waiting_wave.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_wave)
            Waiting_wind.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_wind)
            Waiting_commission.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_com)
            Waiting_tide.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_tide)
            Waiting_WindWave.loc[str(year), 'Month ' + str(month)] = math.ceil(waiting_wind_wave)

            # %% Results
            # ------ results-------

            print(year,'Month ' + str(month), 'Total time installation', math.ceil(TOTAL_TIME), 'hours =',
                  math.ceil(TOTAL_TIME / 24), 'days')
            print(year, 'Month ' + str(month), 'Total waiting time', math.ceil(waiting_wtb), 'hours =',
                  math.ceil(waiting_wtb / 24), 'days')

            TOTAL_COST = TOTAL_TIME * (
                    (
                                CHT_J + CHT_B + 3 * CHT_T + CHT_CR * 4 + CHT_CTV) / 24)  # Cost of installation of Turbines, Rental cost/hour

            COST_TOT.loc[str(year), 'Month ' + str(month)] = math.ceil(TOTAL_COST)
            print(year, 'Month ' + str(month), 'Total installation cost', math.ceil(TOTAL_COST),
                  'kDollars')
            if TOTAL_TIME >= MaxDuration:
                Amount = ActualTurbines / N_WTB * 100
                print('Turbines installed after one year: ', ActualTurbines, '=', Amount,
                      '% of wind turbines')
            else:
                print('Completed farm installation')
            print('   ')
        average_T_TOT = T_TOT.loc[:, 'Month ' + str(month)].mean()
        T_TOT.loc["Average (h)", 'Month ' + str(month)] = average_T_TOT

        average_WAIT_TOT = WAIT_TOT.loc[:, 'Month ' + str(month)].mean()
        WAIT_TOT.loc["Average (h)", 'Month ' + str(month)] = average_WAIT_TOT

        average_Waiting_position = Waiting_position.loc[:, 'Month ' + str(month)].mean()
        Waiting_position.loc["Average (h)",'Month ' + str(month)] = average_Waiting_position

        average_Waiting_transfer = Waiting_transfer.loc[:, 'Month ' + str(month)].mean()
        Waiting_transfer.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_transfer

        average_Waiting_connect = Waiting_connect.loc[:, 'Month ' + str(month)].mean()
        Waiting_connect.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_connect

        average_Waiting_tower = Waiting_tower.loc[:, 'Month ' + str(month)].mean()
        Waiting_tower.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_tower

        average_Waiting_nacelle = Waiting_nacelle.loc[:, 'Month ' + str(month)].mean()
        Waiting_nacelle.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_nacelle

        average_Waiting_blade = Waiting_blade.loc[:, 'Month ' + str(month)].mean()
        Waiting_blade.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_blade

        average_Waiting_transit = Waiting_transit.loc[:, 'Month ' + str(month)].mean()
        Waiting_transit.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_transit

        average_Waiting_wave = Waiting_wave.loc[:, 'Month ' + str(month)].mean()
        Waiting_wave.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_wave

        average_Waiting_wind = Waiting_wind.loc[:, 'Month ' + str(month)].mean()
        Waiting_wind.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_wind

        average_Waiting_com = Waiting_commission.loc[:, 'Month ' + str(month)].mean()
        Waiting_commission.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_com

        average_Waiting_tide = Waiting_tide.loc[:, 'Month ' + str(month)].mean()
        Waiting_tide.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_tide

        average_Waiting_WindWave = Waiting_WindWave.loc[:, 'Month ' + str(month)].mean()
        Waiting_WindWave.loc["Average (h)", 'Month ' + str(month)] = average_Waiting_WindWave

        average_COST_TOT = COST_TOT.loc[:, 'Month ' + str(month)].mean()
        COST_TOT.loc["Average (h)", 'Month ' + str(month)] = average_COST_TOT

        days_av_T_TOT = T_TOT.loc[:, 'Month ' + str(month)].mean() / 24
        T_TOT.loc["Average (days)", 'Month ' + str(month)] = days_av_T_TOT

        days_av_WAIT_TOT = WAIT_TOT.loc[:, 'Month ' + str(month)].mean() / 24
        WAIT_TOT.loc["Average (days)", 'Month ' + str(month)] = days_av_WAIT_TOT

        days_av_Waiting_position = Waiting_position.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_position.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_position

        days_av_Waiting_transfer = Waiting_transfer.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_transfer.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_transfer

        days_av_Waiting_connect = Waiting_connect.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_connect.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_connect

        days_av_Waiting_tower = Waiting_tower.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_tower.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_tower

        days_av_Waiting_nacelle = Waiting_nacelle.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_nacelle.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_nacelle

        days_av_Waiting_blade = Waiting_blade.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_blade.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_blade

        days_av_Waiting_transit = Waiting_transit.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_transit.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_transit

        days_av_Waiting_wave = Waiting_wave.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_wave.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_wave

        days_av_Waiting_wind = Waiting_wind.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_wind.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_wind

        days_av_Waiting_com = Waiting_commission.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_commission.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_com

        days_av_Waiting_tide = Waiting_tide.loc[:, 'Month ' + str(month)].mean() / 24
        Waiting_tide.loc["Average (days)", 'Month ' + str(month)] = days_av_Waiting_tide

        days_av_COST_TOT = COST_TOT.loc[:, 'Month ' + str(month)].mean() / 24
        COST_TOT.loc["Average (days)", 'Month ' + str(month)] = days_av_COST_TOT

    # Create a Pandas Excel writer using XlsxWriter as the engine
    filename = F_Size + ' Month Check.xlsx'
